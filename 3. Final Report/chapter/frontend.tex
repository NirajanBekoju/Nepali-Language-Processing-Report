...
% \begin{figure}[H]
%     \centering
%     \includegraphics[scale = 0.35]{frontend/home_light.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[scale = 0.35]{frontend/probabilistic_frontend.png}
%     \caption{Proabilistic LM Frontend}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[scale = 0.35]{frontend/sentimental_frontend.png}
%     \caption{Sentimental Classifier Frontend}
%     \label{fig: Sentimental Classifier Frontend}
% \end{figure}
