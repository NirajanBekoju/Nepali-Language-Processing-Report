...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.6]{sentimental_classifier_model/kaggle_hugging_face_data.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.6]{sentimental_classifier_model/bert/cm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{sentimental_classifier_model/bert/cr.png}
